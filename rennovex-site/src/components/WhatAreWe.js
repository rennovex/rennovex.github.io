...
const Whatarewe = () => {
    return <section className={classes.Whatarewe} id='aim'>
    ...
    <p className = {classes.Whatarewe__desc}>We work with the Lean startup method to rapidly test and deploy our products</p></div>
